                    ...
                    <div class="main-menu-two__wrapper-inner">
                        <div class="main-menu-two__left">
                            <div class="main-menu-two__logo">
                                <a href="{{url('/')}}"><img src="{{ asset('frontend/assets/images/resources/pkm-imgs.png')}}" alt=""></a>
                            </div>
...
"marginBottom":"20","marginRight":"20","position":"right"},"brandSetting":{"brandName":"Puskesmas Batin",
